  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="mb-6 md:mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-white mb-2">System Configuration</h1>
          <p className="text-slate-400 text-sm">Manage your profile, security preferences, and autonomous agent behavior.</p>
        </div>
        <button 
          onClick={handleSave}
          className={`
      ...
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
        ...
        <div className="w-full lg:w-64 flex-shrink-0">
          <div className="bg-surface border border-slate-800 rounded-xl overflow-x-auto lg:overflow-hidden flex lg:flex-col sticky top-4 lg:top-8 scrollbar-hide">
            {Tabs.map((tab) => {
              const Icon = tab.icon;
              ...
              return (
                <button
                  ...
                  className={`
                    flex-shrink-0 lg:flex-shrink flex items-center gap-3 px-4 py-4 text-sm font-medium transition-colors border-b-2 lg:border-b-0 lg:border-l-2 whitespace-nowrap
                    ${isActive 
        ...
        {/* Main Content Area */}
        <div className="flex-1 bg-surface border border-slate-800 rounded-xl p-6 md:p-8 min-h-[600px]">
  ...
  <div className="space-y-8">
    <div>
      ...
      <div className="space-y-4 max-w-2xl">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-slate-900/50 rounded-lg border border-slate-800 gap-4">
    ...
    <div className="pt-8 border-t border-slate-800">
      ...
      <div className="space-y-3">
        {[
            ...
            <div key={i} className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-slate-950 border border-slate-800 rounded-lg gap-2">
                <div>
                ...
                <button className="text-red-400 hover:text-red-300 text-xs font-bold uppercase self-start sm:self-center">Revoke</button>
            </div>
        ))}
            ...
            <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-6 space-y-6">
                ...
                <div className="space-y-3">
                    <div className="flex flex-col sm:flex-row sm:justify-between gap-2">
                        ...
                        <span className="text-xs font-mono bg-yellow-500/10 text-yellow-500 px-2 py-0.5 rounded self-start">Requires Approval</span>
                    </div>
        ...
        <div className="bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 rounded-xl p-6 relative overflow-hidden">
            ...
            <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <button className="bg-white hover:bg-slate-200 text-slate-950 font-bold px-4 py-2 rounded-lg text-sm transition-colors text-center">
                        Manage Subscription
                    </button>
                    <button className="text-slate-400 hover:text-white font-medium text-sm text-center">
                        View Invoices
                    </button>
                </div>
            </div>
